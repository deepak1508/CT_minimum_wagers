...
//                    sCallback.onYesClicked();
                    ...
                    if (ratingBar.getRating() >= sConfig.getMinimumTargetRating()) {
                        ...
                        setNeverShowAgain(context, true);
                      /* int int ratinggiven= (int) ratingBar.getRating();

                        cleverTapDefaultInstance.pushEvent("Rating given");

                        HashMap<String, Object> prodViewedAction = new HashMap<>();
                        prodViewedAction.put("Rating", ratinggiven);
                        cleverTapDefaultInstance.pushEvent("Rating given", prodViewedAction);
                        //OR
                        CleverTapAPI.setDebugLevel(1277182231);
                        System.out.println("rating value"+ratinggiven);*/
